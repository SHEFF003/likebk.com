...
Statistic.prototype.showMonstr = function()
{
	...
	var c = 0;
	var color = initvars.hlColor;
	console.log('initvars.hlColorinitvars.hlColorinitvars.hlColor='+initvars.hlColor)
	var minlevel = 21;
	var maxlevel = 0;
	var isMstrLvl=false;
	var isLvl=false;
...
Underground.prototype.redrawMap = function(fnum){
	...
	if(localStorage.Mgla == undefined){
		li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'
	}else if(localStorage.Mgla != 1){
		li1 = '<li style="list-style:none;" id="menuFloor1Click"><a href="javascript:startMapDrawing(2,0)" style="font-size: 16px;" >1-й этаж</a></li>'
	}else{
		li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'
	}
	if(localStorage.Mgla != 2){
		li2 = '<li style="list-style:none;" id="menuFloor2Click"><a href="javascript:startMapDrawing(2,1)" style="font-size: 16px;" >2-й этаж</a></li>'
	}else{
		li2 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor2Click">2-й этаж</li>'
	}
	if(localStorage.Mgla != 3){
		li3 = '<li style="list-style:none;" id="menuFloor3Click"><a href="javascript:startMapDrawing(2,2)" style="font-size: 16px;" >3-й этаж</a></li>'
	}else{
		li3 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor3Click">3-й этаж</li>'
	}
	if(localStorage.Mgla != 4){
		li4 = '<li style="list-style:none;" id="menuFloor4Click"><a href="javascript:startMapDrawing(2,3)" style="font-size: 16px;" >4-й этаж</a></li>'
	}else{
		li4 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor4Click">4-й этаж</li>'
	}

	document.getElementById('floorMenu').innerHTML = '<ul style="margin-left: -70px; font-size: 16px;"><li style="list-style-type:none;color:#990000;font-size: 18px;font-weight: bold;"><img src="pages/maps/images/city/7.gif" border="0" align="absmiddle">&nbsp;Пещеры Мглы<ul >'+li1+li2+li3+li4+'</ul></li></ul>';
