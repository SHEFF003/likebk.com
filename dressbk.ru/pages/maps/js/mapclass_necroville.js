...
Underground.prototype.redrawMap = function(fnum){
	...
	var li1  = '<li style="list-style:none;" id="menuFloor1Click"><a href="javascript:startMapDrawing(9,0)" style="font-size: 16px;" >1-й этаж</a></li>'
	document.getElementById('floorMenu').innerHTML = '<ul style="margin-left: -70px; font-size: 16px;"><li style="list-style-type:none;color:#990000;font-size: 18px;font-weight: bold;"><img src="pages/maps/images/city/11.gif" border="0" align="absmiddle">&nbsp;Туманные Низины<ul >'+li1+'</ul></li></ul>';
