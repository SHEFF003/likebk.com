...
Underground.prototype.drawMap = function(fnum){
	...
	baseDiv += '<ul id="floorMenu" style="width:260px;margin:15px 0px;"></ul></td></tr><tr>';
...
Underground.prototype.redrawMap = function(fnum){
	...
	var li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'


	document.getElementById('floorMenu').innerHTML = '<ul style="margin-left: -70px; font-size: 16px;"><li style="list-style-type:none;color:#990000;font-size: 18px;font-weight: bold;"><img src="pages/maps/images/city/brend3.gif" border="0" align="absmiddle">&nbsp;Сторожевая Башня<ul >'+li1+'</ul></li></ul>';
