...
Underground.prototype.redrawMap = function(fnum){
	...
	if(localStorage.KatiFloor == undefined){
		...
		li1 = '<li style="list-style:none;" id="menuFloor1Click"><a href="javascript:startMapDrawing(4,0)" style="font-size: 16px;" >1-й этаж</a></li>'
	}else{
		li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'
	}
	if(localStorage.KatiFloor != 2){
		li2 = '<li style="list-style:none;" id="menuFloor2Click"><a href="javascript:startMapDrawing(4,1)" style="font-size: 16px;" >2-й этаж</a></li>'
	}else{
		li2 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor2Click">2-й этаж</li>'
	}
	if(localStorage.KatiFloor != 3){
		li3 = '<li style="list-style:none;" id="menuFloor3Click"><a href="javascript:startMapDrawing(4,2)" style="font-size: 16px;" >3-й этаж</a></li>'
	}else{
		li3 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor3Click">3-й этаж</li>'
	}
	
	document.getElementById('floorMenu').innerHTML = '<ul style="margin-left: -70px; font-size: 16px;"><li style="list-style-type:none;color:#990000;font-size: 18px;font-weight: bold;"><img src="pages/maps/images/city/10.gif" border="0" align="absmiddle">&nbsp;Потерянный Вход<ul >'+li1+li2+li3+li4+'</ul></li></ul>';
