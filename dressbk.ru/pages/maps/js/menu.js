...
function genMenu(MA,MI,MU)
{
	...
	for(var i=0; i<ITEM.length; i++)
	{
		...
		document.write('<tr><td '+bgcolor+' onMouseOver="this.style.backgroundColor=\'A9A9A9\'" onMouseOut="this.style.backgroundColor=\'dcdcdc\'" nowrap><div id=n1><div id=n2><a href="'+URL[i]+'" class="LayerNavLink"><img src=/http://darkclan-mbk.clan.su/images/pixel.gif height=13 width=100% border=0></div></div><font color="#464646">•</font>&nbsp;'+ITEM[i]+'</a></td></tr>');
	}
...
{ 
    ...
    if (type_old == "block"){ 
         type='none';text_td='/http://darkclan-mbk.clan.su/images/open.gif'; 
     }else{ 
         type='block';text_td='/http://darkclan-mbk.clan.su/images/close.gif'; 
    }; 
