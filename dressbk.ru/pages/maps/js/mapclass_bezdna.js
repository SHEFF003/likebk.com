...
Underground.prototype.redrawMap = function(fnum){
	...
	if(localStorage.BezdnaFloor == undefined){
		li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'
	}else if(localStorage.BezdnaFloor != 1){
		li1 = '<li style="list-style:none;" id="menuFloor1Click"><a href="javascript:startMapDrawing(1,0)" style="font-size: 16px;" >1-й этаж</a></li>'
	}else{
		li1 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor1Click">1-й этаж</li>'
	}
	if(localStorage.BezdnaFloor != 2){
		li2 = '<li style="list-style:none;" id="menuFloor2Click"><a href="javascript:startMapDrawing(1,1)" style="font-size: 16px;" >2-й этаж</a></li>'
	}else{
		li2 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor2Click">2-й этаж</li>'
	}
	if(localStorage.BezdnaFloor != 3){
		li3 = '<li style="list-style:none;" id="menuFloor3Click"><a href="javascript:startMapDrawing(1,2)" style="font-size: 16px;" >3-й этаж</a></li>'
	}else{
		li3 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor3Click">3-й этаж</li>'
	}
	if(localStorage.BezdnaFloor != 4){
		li4 = '<li style="list-style:none;" id="menuFloor4Click"><a href="javascript:startMapDrawing(1,3)" style="font-size: 16px;" >4-й этаж</a></li>'
	}else{
		li4 = '<li style="list-style:none;font-size: 16px;font-weight: bold;" id="menuFloor4Click">4-й этаж</li>'
	}	

	document.getElementById('floorMenu').innerHTML = '<ul style="margin-left: -70px; font-size: 16px;"><li style="list-style-type:none;color:#990000;font-size: 18px;font-weight: bold;"><img src="pages/maps/images/city/2.gif" border="0" align="absmiddle">&nbsp;Бездна<ul >'+li1+li2+li3+li4+'</ul></li></ul>';
	...
	menuLink1.onclick = function() {
		localStorage.BezdnaFloor = 1;
	}
	menuLink2.onclick = function() {
		localStorage.BezdnaFloor = 2;
	}
	menuLink3.onclick = function() {
		localStorage.BezdnaFloor = 3;
	}
	menuLink4.onclick = function() {
		localStorage.BezdnaFloor = 4;
	}
