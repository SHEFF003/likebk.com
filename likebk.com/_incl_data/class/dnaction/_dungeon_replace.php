...
<div id="clip76" style="display: none; color: black;">
 <p style="color:<?=getColor(877, 1)?>"> Cталь <img src="http://img.likebk.com/<?=getImg(877, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(882, 1)?>"> Глубинный камень <img src="http://img.likebk.com/<?=getImg(882, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(902, 1)?>"> Плод змеиного дерева <img src="http://img.likebk.com/<?=getImg(902, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(903, 1)?>"> Тысячелетний камень <img src="http://img.likebk.com/<?=getImg(903, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(881, 1)?>"> Лучистый рубин <img src="http://img.likebk.com/<?=getImg(881, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(878, 1)?>"> Лучистый топаз <img src="http://img.likebk.com/<?=getImg(878, 1)?>" width="13" height="13" /></p>
...
<div id="clip80" style="display: none; color: black;">
 <p style="color:<?=getColor(895, 1)?>"> Лучистое серебро <img src="http://img.likebk.com/<?=getImg(895, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(889, 3)?>"> Сгусток эфира (3 шт.) <img src="http://img.likebk.com/<?=getImg(889, 3)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(906, 1)?>"> Кристалл голоса предков <img src="http://img.likebk.com/<?=getImg(906, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(908, 1)?>"> Камень затаенного солнца <img src="http://img.likebk.com/<?=getImg(908, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(888, 1)?>"> Шепот гор <img src="http://img.likebk.com/<?=getImg(888, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(909, 1)?>"> Эссенция праведного гнева <img src="http://img.likebk.com/<?=getImg(909, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(905, 1)?>"> Стихиалия <img src="http://img.likebk.com/<?=getImg(905, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip81"  style="display: none; color: black;">
 <p style="color:<?=getColor(906, 1)?>"> Кристалл голоса предков <img src="http://img.likebk.com/<?=getImg(906, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(907, 1)?>"> Кристалл стабильности <img src="http://img.likebk.com/<?=getImg(907, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip82" style="display: none; color: black;">
 <p style="color:<?=getColor(877, 1)?>"> Сталь <img src="http://img.likebk.com/<?=getImg(877, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(890, 1)?>"> Сгусток астрала <img src="http://img.likebk.com/<?=getImg(890, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(902, 1)?>"> Плод змеиного дерева <img src="http://img.likebk.com/<?=getImg(902, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(903, 1)?>"> Тысячелетний камень <img src="http://img.likebk.com/<?=getImg(903, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(888, 1)?>"> Шепот гор <img src="http://img.likebk.com/<?=getImg(888, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip89" style="display: none; color: black;">
 <p style="color:<?=getColor(900, 1)?>"> Кора змеиного дерева <img src="http://img.likebk.com/<?=getImg(900, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(882, 1)?>"> Глубинный камень <img src="http://img.likebk.com/<?=getImg(882, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(903, 1)?>"> Тысячелетний камень <img src="http://img.likebk.com/<?=getImg(903, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(904, 1)?>"> Кристалл времен <img src="http://img.likebk.com/<?=getImg(904, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(908, 1)?>"> Камень затаенного солнца <img src="http://img.likebk.com/<?=getImg(908, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip90" style="display: none; color: black;">
 <p style="color:<?=getColor(950, 1)?>"> Кожа Общего Врага <img src="http://img.likebk.com/<?=getImg(950, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(889, 1)?>"> Сгусток эфира <img src="http://img.likebk.com/<?=getImg(889, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(902, 1)?>"> Плод змеиного дерева <img src="http://img.likebk.com/<?=getImg(902, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(903, 1)?>"> Тысячелетний камень <img src="http://img.likebk.com/<?=getImg(903, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(878, 1)?>"> Лучистый топаз <img src="http://img.likebk.com/<?=getImg(878, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip93" style="display: none; color: black;">
 <p style="color:<?=getColor(901, 1)?>"> Кристалл тысячи ответов <img src="http://img.likebk.com/<?=getImg(901, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(889, 1)?>"> Сгусток эфира <img src="http://img.likebk.com/<?=getImg(889, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(890, 1)?>"> Сгусток астрала <img src="http://img.likebk.com/<?=getImg(890, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
...
<div id="clip94" style="display: none; color: black;">
 <p style="color:<?=getColor(4685, 1)?>"> Зачаровать кольцо: Вытягивание души [1] <img src="http://img.likebk.com/<?=getImg(4685, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(4688, 1)?>"> Топливо для Големов <img src="http://img.likebk.com/<?=getImg(4688, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(4689, 1)?>"> Смазка для Големов <img src="http://img.likebk.com/<?=getImg(4689, 1)?>" width="13" height="13" /></p>
 <p style="color:<?=getColor(4690, 1)?>"> Ускоритель для Големов <img src="http://img.likebk.com/<?=getImg(4690, 1)?>" width="13" height="13" /></p>
<form action="" method="POST">
