...
if( isset($pr_momental_this)) {
	...
	$cup = true;
	echo '<div><font color="red"><b>Повелитель Багов в очередной раз сломал прием... Не удалось использовать.</font></div>';
	//Действие при клике
	//if( $btl->info['id'] == 7637 || $btl->info['id'] == 24848 ) {
		//$this->addEffPr($pl,$id);
	//}else{
	//	echo '<div><font color="red"><b>Прием временно недоступен!</b></font></div>';
	//	$cup = true;
	//}
	die();
}
