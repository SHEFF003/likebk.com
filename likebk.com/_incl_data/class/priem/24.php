...
if( isset($pr_momental_this)) {
	...
	*/
	//$btlgt = mysql_fetch_array(mysql_query('SELECT `id` FROM `battle_act` WHERE `uid1` = "'.$u->info['id'].'" AND `uid2` = "'.$u->info['enemy'].'" AND `battle` = "'.$u->info['battle'].'" LIMIT 1'));
	//if( $u->info['enemy'] > 0 && $btl->stats[$btl->uids[$u->info['enemy']]] >= 1 && !isset($btlgt['id']) ) {
				//
