		...
		if( !isset(season::$m['id']) ) {
			...
			if( season::$m['dd'] > season::$date['d'] ) {
				...
				while( $pl = mysql_fetch_array($sp) ) {
					...
					if( $f == 1 ) {
						$ends[$i] = true;
						$html .= '<b style="color:#efefef"><img src="http://img.likebk.com/i/ico/wins.gif"> Задание выполнено.</b>';
					}elseif( $nogo == true ) {
						$html .= '<i style="color:#ffa5a5"><img src="http://img.likebk.com/i/ico/draw.gif"> Требует выполнение предыдущего задания.</i>';
					}
