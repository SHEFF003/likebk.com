				...
				while( i < data.x ) {
					if( data[i] != undefined ) {
						...
						r += '<tr id="itm_auction' + data[i][22] + '">'+
							'<td align="center" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;" valign="middle"><img style="padding:10px;" onMouseOver="top.hi(this,\'' + this.replaceslashhint(itmjs.infoItem( data , i , 'auction_info' )) + '\',event,0,0,1,1,\'max-width:307px\')" onMouseOut="top.hic();" onMouseDown="top.hic();" src="http://img.likebk.com/i/items/' + data[i][2] + '"><br><small>(id' + data[i][22] + ')</small></td>'+
							...
							//'<td align="center" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;" valign="middle"><img style="padding:10px;" src="http://img.likebk.com/i/items/' + data[i][2] + '"><br><img src="http://img.likebk.com/auc_watch_off.png" title="Отслеживание (будет отображаться в разделе [Ставки])" class="cp"> <img src="http://img.likebk.com/auc_bet1.png" title="Сделать ставку" class="cp"></td>'+
							'<td align="left" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;padding-left:10px;" valign="middle"><a onMouseOver="top.hi(this,\'' + this.replaceslashhint(itmjs.infoItem( data , i , 'auction_info' )) + '\',event,0,0,1,1,\'max-width:307px\')" onMouseOut="top.hic();" onMouseDown="top.hic();" href="http://likebk.com/item/' + data[i].item_id + '" target="_blank">' + data[i].name + '</a> &nbsp; (Масса: ' + data[i].massa + ')<br>Долговечность: ' + Math.ceil(data[i].iznosNOW) + '/' + Math.ceil(data[i].iznosMAX) + '</td>'+
			...
			if( data.x != undefined && data.x > 0 ) {
				...
				while( i < data.x ) {
					if( data[i] != undefined ) {
						...
						r += '<tr id="itm_auction' + data[i][22] + '">'+
							'<td align="center" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;" valign="middle"><img style="padding:10px;" src="http://img.likebk.com/i/items/' + data[i][2] + '"><br><small>(id' + data[i][22] + ')</small></td>'+
							//'<td align="center" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;" valign="middle"><img style="padding:10px;" src="http://img.likebk.com/i/items/' + data[i][2] + '"><br><img src="http://img.likebk.com/auc_watch_off.png" title="Отслеживание (будет отображаться в разделе [Ставки])" class="cp"> <img src="http://img.likebk.com/auc_bet1.png" title="Сделать ставку" class="cp"></td>'+
							//'<td align="left" style="border-top:1px solid #a5a5a5;border-right:1px solid #a5a5a5;padding-left:10px;" valign="middle"><a href="http://likebk.com/item/' + data[i].item_id + '" target="_blank">' + data[i].name + '</a> &nbsp; (Масса: ' + data[i].massa + ')<br>Долговечность: ' + Math.ceil(data[i].iznosNOW) + '/' + Math.ceil(data[i].iznosMAX) + '</td>'+
