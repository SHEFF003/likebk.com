...
var locline = {
	...
	line:function( a , b , c , reflesh ) {
		...
		r += '<table height="15" border="0" cellspacing="0" cellpadding="0">' + 
			   ...
			   '<a id="line_rel1" style="display:' +d1+ ';cursor:pointer" onclick="locline.lineRefleshStart();' + reflesh + '"><img style="display:block;" src="http://img.likebk.com/i/move/rel_1.gif" width="15" height="16" title="Обновить" border="0" /></a>'+
			   '<a id="line_rel2" style="display:' +d2+ ';cursor:pointer"><img style="display:block;" src="http://img.likebk.com/i/move/rel_2.gif" width="15" height="16" title="Обновить" border="0" /></a>'+
			   '</td>'+
               ...
               '<td><img style="display:block;" src="http://img.likebk.com/i/move/navigatin_481.gif" width="9" height="8" /></td>'+
               		'<td width="64" bgcolor="black"><img src="http://img.likebk.com/1x1.gif" style="background:url(http://img.likebk.com/i/move/wait2.gif) 0px 0px repeat-y;height:6px;display:block;" id="MoveLine" height="8" style="width:33px;" /></td>'+
...
Сейчас в комнате 0 чел.">Центральная Площадь</a></td>
		...
		*/
		...
		while( i != - 1 ) {
			if( data[i] != undefined ) {
				r += '<tr><td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td>';
