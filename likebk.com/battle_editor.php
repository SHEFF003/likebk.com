...
<script src="http://img.likebk.com/js/gameEngine.js" type="text/javascript"></script>
...
<body bgcolor="#E2E0E0">
<H3>Настройка боевого балансa<br><a href="/battle_editor.php" class="btnnew">Обновить</a></H3>
<br>
<?
if( isset($_POST['val1']) ) {	
	$i = 1;
