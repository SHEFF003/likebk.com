  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
    ...
    <tr>
	  ...
	  if( $rz == 1 ) {
		  ...
		  while($pl = mysql_fetch_array($sp)) {
			  $r .= '<tr><td align="center">'.$i.'</td><td><img src="http://img.likebk.com/i/align/align'.$pl['align'].'.gif" width=12 height=15><img width=24 height=15 src="http://img.likebk.com/i/clan/'.$pl['id'].'.gif"> <small>Ур. '.$pl['level'].'</small> <a target="_blank" href="http://likebk.com/clans_inf.php?'.$pl['name'].'">'.$pl['name'].'</a></td><td align="center">'.$pl['exp'].'</td><td></td>';
			  $i++;
		  }
	  }elseif( $rz == 2 ) {
		  $rf_i = array();
