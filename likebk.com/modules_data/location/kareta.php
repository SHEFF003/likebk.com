        ...
        <tr>
			...
			*/
			...
			?>
              <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="220" height="175">
                <param name="movie" value="http://img.likebk.com/i/kareta<? if($outimg==''){ $outimg = 1; } echo $outimg; ?>.swf" />
                <param name="quality" value="high" />
                <param name="SCALE" value="exactfit" />
                <embed src="http://img.likebk.com/i/kareta<? echo $outimg; ?>.swf" width="220" height="175" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" scale="exactfit"></embed>
              </object>
            </div></td>
          <td valign="middle"><p>&nbsp;</p>
            ...
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="670" height="428">
              <param name="movie" value="http://img.likebk.com/flash/puzzle<? echo rand(1,13); ?>.swf" />
              <param name="quality" value="high" /><param name="SCALE" value="exactfit" />
              <embed src="http://img.likebk.com/flash/puzzle<? echo rand(1,13); ?>.swf" width="670" height="428" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" scale="exactfit"></embed>
            </object>
            </div></td>
        </tr>
      </table>
