        ...
        <tr align="right" valign="top">
          <td>
                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                    <div style="position:relative; cursor: pointer; width: 500px;" id="ione"><img src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_bg1_1.jpg" id="img_ione" width="500" height="268"  border="1"/>
                      ...
                      <div style="position: absolute; left: 16px; top: 202px; width: 41px; height: 14px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_left.gif" width="41" height="14" <? thisInfRm('1.180.0.x'); ?> /></div>
                      
                      <div style="position: absolute; left: 438px; top: 202px; width: 41px; height: 14px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_right.gif" width="41" height="14" <? thisInfRm('7.180.0.387'); ?> /></div>
                      
                      <div style="position: absolute; left: 159px; top: 92px; width: 75px; height: 90px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_portal.gif" width="75" height="90" <? thisInfRm('7.180.0.385'); ?> /></div>
