        ...
        <tr align="right" valign="top">
          <td>
                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                    <div style="position:relative; cursor: pointer; width: 500px;" id="ione"><img src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_bg2_1.jpg" id="img_ione" width="500" height="268"  border="1"/>
                      ...
                      <div style="position: absolute; left: 16px; top: 202px; width: 41px; height: 14px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_left.gif" width="41" height="14" <? thisInfRm('7.180.0.386'); ?> /></div>
                      
                      <div style="position: absolute; left: 438px; top: 202px; width: 41px; height: 14px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_right.gif" width="41" height="14" <? thisInfRm('7.180.0.xx'); ?> /></div>
                      
                      <div style="position: absolute; left: 127px; top: 56px; width: 157px; height: 83px; z-index: 910;"><img class="aFilter"  src="http://img.likebk.com/i/images/300x225/emerald/<?=$nd?>/em_casino.gif" width="157" height="83" <? thisInfRm('7.180.0.388'); ?> /></div>
					  ...
					  //if($u->info['admin'] > 0 ) {
						...
						?>
                        <div style="position: absolute; left: 230px; top: 162px; width: 32px; height: 43px; z-index: 91;"><img onclick="location.href='main.php?talk=5'" title="Диалог с Тыквоголовым" src="http://img.likebk.com/loca/cp11/sun_pmd.gif" width="32" height="43" title="" class="aFilter" /></div>
                        <?  
						  }elseif( date('m') == 12 || date('m') == 1 ) {
							 //Елка НГ
						?>
						<div style="position: absolute; left: 212px; top: 133px; width: 32px; height: 43px; z-index: 91;"><img <? thisInfRm('1.180.0.208'); ?> src="http://img.likebk.com/newyear2014.png" width="60" height="90" title="" class="aFilter" /></div>
						<?
                          }*/
					  //}
					  ?>
