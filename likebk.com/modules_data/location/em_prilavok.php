...
if(isset($file) && $file[0]=='em_prilavok.php')
{
	$shopProcent = 50;
	...
	<tr><td valign="top"><div align="center" class="pH3">Подземный прилавок</div>
	<?php
    ...
    <?php	
		...
		{
			$otdels_small_array = array (1=>'<b>Кольца</b>');
	...
	<tr>
	<td bgcolor="#D3D3D3"><img src="http://img.originalbk.com/i/move/links.gif" width="9" height="7" /></td>
