...
$otdels_small_array = array (1=>'<b>Отдел&nbsp;&quot;Маски: мужские&quot;</b>',
				2=>'<b>Отдел&nbsp;&quot;Маски: женские&quot;</b>',
				3=>'<b>Отдел&nbsp;&quot;Чеки&quot;</b>',
				4=>'<b>Отдел&nbsp;&quot;Лотерея&quot;</b>',
				5=>'<b>Отдел&nbsp;&quot;Зимние накидки&quot;</b>',
				6=>'<b>Отдел&nbsp;&quot;Дополнительные предметы&quot;</b>',
...
<input name="itemgift" id="itemgift" type="hidden" value="0" />
    ...
    <?php
		...
		if(isset($_GET['gifts']))
		{
			...
			while( $pl = mysql_fetch_array($sp) ) {
				...
				//
					'<a href="http://lib.likebk.com/items_info.php?id=0">'.$pl['name'].'</a> &nbsp; (Масса: 1)<br>Долговечность: 0/1<br>'.
	...
	<td bgcolor="#D3D3D3" nowrap><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.208&rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.208',1); ?>">Елка</a></td>
	</tr>
	<tr>
	<!-- <td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td> -->
	...
	<tr>
							...
							<tr>
							  <td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td>
							  <td bgcolor="#D3D3D3" nowrap="nowrap"><div align="left"><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.208&amp;rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.208',1); ?>">Новогодняя Елка</a></div></td>
							</tr></td>
						</table>
	</tr>
    <tr>
							...
							<tr>
							  <td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td>
							  <td bgcolor="#D3D3D3" nowrap="nowrap"><div align="left"><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.417&amp;rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.417',1); ?>">Сезонный магазин</a></div></td>
							</tr></td>
						</table>
                        <? if( date('m') >= 2 ) { ?>
                            	</td>
	</tr>
    <tr><td nowrap="nowrap"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#DEDEDE">
							<tr>
							  <td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td>
							  <td bgcolor="#D3D3D3" nowrap="nowrap"><div align="left"><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.9&amp;rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.9',1); ?>">Центральная Площадь</a></div></td>
							</tr></td></table>
                            <? } ?>
    </tr>
	</table>
	...
	<?php
		...
		echo '<div style="background-color: #C7C7C7"><a href="?otdel=1">Маски: мужские</a></div>
			<div style="background-color: #e2e0e0"><a href="?otdel=2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;женские</a></div>
			<div style="background-color: #e2e0e0"><a href="?otdel=5">Зимние накидки</a></div>
			<div style="background-color: #e2e0e0"><a href="?otdel=6">Дополнительные предметы</a></div>
			<div style="background-color: #e2e0e0"><a href="?otdel=4">Лотерея</a></div>
';
		echo '</div>';
	?>
	</div>
