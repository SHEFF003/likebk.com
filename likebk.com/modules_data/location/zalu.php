                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer;" id="ione">
                        ...
                        <div style="position:absolute; left:337px; top:117px; width:16px; height:18px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/fl1.gif" width="16" height="18" title="Вы находитесь в '<? echo $u->room['name']; ?>'"  /></div>
                        ...
                        <div style="position:absolute; left:78px; top:24px; width:76px; height:18px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/map_zalu6.gif" onclick="alert('Проход через зал паладинов');" width="76" height="18" class="aFilter"  /></div>	
                        <div style="position:absolute; left:17px; top:122px; width:79px; height:32px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/map_zalu3.gif" width="78" height="33" onclick="alert('Проход через зал паладинов');"  /></div>
