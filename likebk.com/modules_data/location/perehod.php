        ...
        <tr align="right" valign="top">
          <td>
                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                    <div style="position:relative; cursor: pointer; width: 500;" id="ione"><img src="http://img.likebk.com/i/images/300x225/club/navig2.jpg" id="img_ione" width="500" height="240"  border="1"/>
                      <div style="position:absolute; left:264px; top:106px; width:175px; height:37px; z-index:90;"><img <? thisInfRm('1.180.0.0'); ?> src="http://img.likebk.com/i/images/subimages/map_zal2.gif" id="mo_1.180.0.0" width="175" height="37" /></div>
                      <div style="position:absolute; left:47px; top:120px; width:135px; height:29px; z-index:90;"><img src="http://img.likebk.com/i/images/subimages/map_zal3.gif" width="135" height="29"  class="aFilter" id="mo_1.180.0.1" /></div>
                      <div style="position:absolute; left:81px; top:102px; width:88px; height:15px; z-index:90;"><img <? thisInfRm('1.180.0.2'); ?> src="http://img.likebk.com/i/images/subimages/map_zal1.gif" width="88" height="15" class="aFilter" id="mo_1.180.0.2" /></div>
                      <div style="position:absolute; left:167px; top:107px; width:16px; height:18px; z-index:90;"><img src="http://img.likebk.com/i/images/subimages/fl1.gif" width="16" height="18" title="Вы находитесь в Комнате перехода"    /></div>
                      <div id="snow"></div>
                      <? echo $goline; ?>
                    </div>
                    </td>
