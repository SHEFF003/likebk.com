        ...
        <tr align="right" valign="top">
          <td>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                    <div style="position:relative; cursor: pointer; width: 500px;" id="ione"><img src="http://img.likebk.com/i/images/300x225/club/navig2.jpg" id="img_ione" width="500" height="240"  border="1"/>
                      <div style="position:absolute; left:264px; top:106px; width:175px; height:37px; z-index:90;"><img src="http://img.likebk.com/i/images/subimages/map_zal2.gif" width="175" height="37" id="mo_1.180.0.0" /></div>
                      <div style="position:absolute; left:47px; top:120px; width:135px; height:29px; z-index:90;"><img <? thisInfRm('1.180.0.1'); ?> src="http://img.likebk.com/i/images/subimages/map_zal3.gif" width="135" height="29"  class="aFilter" id="mo_1.180.0.1" /></div>
                      <div style="position:absolute; left:81px; top:102px; width:88px; height:15px; z-index:90;"><img src="http://img.likebk.com/i/images/subimages/map_zal1.gif" width="88" height="15" title="Вход через Комнату Перехода" id="mo_1.180.0.2" class="aFilter" onclick="alert('Вход через Комнату Перехода')"  /></div>
                      <div style="position:absolute; left:349px; top:139px; width:16px; height:18px; z-index:90;"><img src="http://img.likebk.com/i/images/subimages/fl1.gif" width="16" height="18" title="Вы находитесь в Комнате для Новичков"    /></div>
                      <div id="snow"></div>
                      <? echo $goline; ?>
                    </div>
                    </td>
              ...
              <div align="right" style="text-align:justify; padding: 3px;"><small>&laquo;<? echo $c['title3']; ?>&raquo; приветствует Вас, <b><? echo $u->info['login']; ?></b>.<br />
                ...
                Для этого нажмите на <a href='/main.php?skills=1&amp;side=1'>Способности</a>, а затем, нажимая на <img src="http://img.likebk.com/i/plus.gif" width="9" height="9" /> / <img src="http://img.likebk.com/i/minus.gif" width="9" height="9" />, сформируйте своего персонажа.<br />
                ...
                <input onclick="location.href='main.php?zayvka'" type='button' value='Поединки' class="btn" disabled="disabled" />
                <br />
