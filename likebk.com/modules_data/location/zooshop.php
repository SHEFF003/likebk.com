...
if($u->room['file'] == 'zooshop')
{
    ...
    <?php	
		...
		if(!isset($_GET['sale']) && !isset($_GET['gifts']) && isset($_GET['otdel'])) 
		{
			...
			$otdels_small_array = array (1=>'<b>Зоомагазин: Звери</b>');
...
<tr>
<td bgcolor="#D3D3D3"><img src="http://img.olegfoto.ru/i/move/links.gif" width="9" height="7" /></td>
<td bgcolor="#D3D3D3" nowrap><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.213&rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.213',1); ?>">Восточная окраина</a></td>
</tr>
</table>
</td>
</tr>
...
<div><br />
	...
	<?php
		...
		//$otdels_array = array (1=>'Заклинания:&nbsp;нейтральные',2=>'Амуниция:&nbsp;Еда');
		$otdels_array = array (1=>'Зоомагазин:&nbsp;Звери');
		$i=1;
		while ($i!=-1)
		{
