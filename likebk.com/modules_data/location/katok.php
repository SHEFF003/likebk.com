	...
	while($pl = mysql_fetch_array($sp)) {
		...
		if(isset($bus['id'])) {
			...
			if( $inbot > 0 ) {
				...
				//Выдаем амуницию
				$u->addItem(5815,$inbot);
				if($pl['team'] == 1) {
					$u->addItem(5816,$inbot);
					$u->addItem(5818,$inbot);
					$u->addItem(5820,$inbot);
					$u->addItem(5822,$inbot);
					$u->addItem(5824,$inbot);
				}elseif($pl['team'] == 2) {
					$u->addItem(5817,$inbot);
					$u->addItem(5819,$inbot);
					$u->addItem(5821,$inbot);
					$u->addItem(5823,$inbot);
					$u->addItem(5825,$inbot);
				}
				//
                      ...
                      <tr>
                        <td nowrap="nowrap"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#DEDEDE">
                            <tr>
								...
								<td bgcolor="#D3D3D3" nowrap="nowrap"><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.208&rnd=<? echo $code; ?>';">Выход с катка</a></td>
                            </tr>
                        </table>
						</td>
                      </tr>
