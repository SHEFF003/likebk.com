...
if($u->room['file']=='monwar')
{
	...
	<tr><td valign="top"><br /><br /><div align="center" class="pH3">Монумент Воины</div>
	<?php
	...
	<td bgcolor="#D3D3D3" nowrap><a href="javascript:void(0)" id="greyText" class="menutop" onclick="location='main.php?loc=1.180.0.213&rnd=<? echo $code; ?>';" title="<? thisInfRm('1.180.0.213',1); ?>">Восточная окраина</a></td>
	</tr>
	</table>
	</td>
	</tr>
	...
	<?php
		...
		$test = 'Камни';
		$otdels_array = array (19=>'Заклинания: нейтральные',20=>'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;боевые и защитные',21=>'Амуниция',22=>'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Эликсиры',23=>'Прочее', 25 => ''.$test.'');
		$i=1;
		while ($i!=-1)
		{
