                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.likebk.com/i/images/300x225/ap_bg_iz_npc100500.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <div style="position: absolute; left: 430px; top: 196px; width: 48px; height: 33px; z-index: 94;"><img <? thisInfRm('3.180.0.268'); ?> src="http://img.likebk.com/i/images/300x225/ab_iz_exit.gif" width="48" height="33" class="aFilter" /></div>
                      <div style="position: absolute; left: 278px; top: 53px; width: 167px; height: 94px; z-index: 94;"><img <? thisInfRm('3.180.0.269'); ?> src="http://img.likebk.com/i/images/300x225/ab_iz_gate.gif" width="167" height="94" class="aFilter" /></div>
					  <div style="position: absolute; left: 22px; top: 161px; width: 75px; height: 68px; z-index: 94;"><img <? thisInfRm('3.180.0.??'); ?> src="http://img.likebk.com/i/images/300x225/ab_iz_shop.gif" width="75" height="68" class="aFilter" /></div>
                      <div style="position: absolute; left: 112px; top: 13px; width: 75px; height: 68px; z-index: 94;"><img onclick="location.href='main.php?talk=4'" src="http://img.likebk.com/i/images/300x225/ab_iz_npc.gif" width="110" height="177" class="aFilter" title="Диалог с Шейла" /></div>
                      <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
