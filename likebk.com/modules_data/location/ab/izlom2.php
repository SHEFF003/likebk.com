...
if(isset($_POST['level']))
{
	...
	if(date('m') == 3 && date('d') < 22 && true == false) {
		echo '<font color="red"><b>Излом хаоса закрыт на доработку до 22 марта!</b></font>';
	}elseif((int)$_POST['level'] <= $u->info['level'] && (int)$_POST['level'] <= $dop_lvl)
	{
...
?>
	...
	body
	{
		...
		background-image: url(http://img.likebk.com/p_portal23.jpg);
					  ...
					  <tr>
						<td nowrap="nowrap"><table width="100%"  border="0" cellpadding="0" cellspacing="1" bgcolor="#DEDEDE">
							<tr>
                              ...
                              <td bgcolor="#D3D3D3" nowrap="nowrap"><a href="#" id="greyText" class="menutop" onclick="location='main.php?loc=<? echo '1.180.0.321'; ?>&rnd=<? echo $code; ?>';" title="<?thisInfRm('1.180.0.321',1);?>"><? echo "Магический Портал";?></a>
							</td>
                            </tr>
							<tr>
							  <td bgcolor="#D3D3D3"><img src="http://img.likebk.com/i/move/links.gif" width="9" height="7" /></td>
