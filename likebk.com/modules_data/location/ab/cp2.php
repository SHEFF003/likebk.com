                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.likebk.com/i/images/300x225/ab_bg107_1.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <div style="position:absolute; left:24px; top:52px; width:29px; height:25px; z-index:94;"><img <? thisInfRm('3.180.0.267'); ?> src="http://img.likebk.com/i/images/300x225/dm_left.gif" width="29" height="25" class="aFilter" /></div>
                      <div style="position:absolute; left:86px; top:59px; width:45px; height:63px; z-index:94;"><img <? thisInfRm('3.180.0.353'); ?> src="http://img.likebk.com/i/images/300x225/ab_107_tower1.gif" width="45" height="63" class="aFilter" /></div>
					  <div style="position:absolute; left:320px; top:55px; width:34px; height:63px; z-index:94;"><img <? thisInfRm('3.180.0.278'); ?> src="http://img.likebk.com/i/images/300x225/dungeon/ab_107_tower2.gif" width="34" height="63" class="aFilter" /></div>
                        <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
