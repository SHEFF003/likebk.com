...
$otdels_small_array = array (1=>'<b>Отдел&nbsp;&quot;Праздничные Маски&quot;</b>');
...
<input name="itemgift" id="itemgift" type="hidden" value="0" />
	...
	<?php
		...
		echo '<div style="background-color: #C7C7C7"><a href="?otdel=1">Праздничные маски</a></div>';
		echo '</div>';
	?>
	</div>
	</td>
