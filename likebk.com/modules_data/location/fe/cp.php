                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.likebk.com/fallenearth/city.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <div style="position:absolute; left:345px; top:115px; width:60px; height:45px; overflow:hidden; z-index:94;"><img src="http://img.likebk.com/fallenearth/fe_shop.png" alt="" width="60" class="combats2" height="90" <? thisInfRm('6.180.0.150'); ?> /></div>
					  
					  <div style="position:absolute; left:425px; top:83px; width:51px; height:78px; overflow:hidden; z-index:94;"><img src="http://img.likebk.com/fallenearth/fe_darkportal.png" alt="" width="51" class="combats3" height="156" <? thisInfRm('6.180.0.102'); ?> /></div>
					  
					  <div style="position:absolute; left:125px; top:75px; width:59px; height:42px; overflow:hidden; z-index:94;"><img src="http://img.likebk.com/fallenearth/fe_sclep.png" alt="" width="59" class="combats4" height="84" <? thisInfRm('6.180.0.103'); ?> /></div>
                    
                      <div style="position:absolute; left:188px; top:19px; width:105px; height:95px; overflow:hidden; z-index:94;"><img src="http://img.likebk.com/fallenearth/fe_club.png" alt="" width="105" class="combats1" height="190" <? thisInfRm('6.180.0.101'); ?> /></div>
                      <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
