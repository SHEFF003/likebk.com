                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.likebk.com/i/images/300x225/fallenearth/sclep.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <div style="position:absolute; left:10px; top:160px; width:29px; height:25px; z-index:94;"><img <? thisInfRm('6.180.0.100'); ?> src="http://img.likebk.com/i/images/300x225/fallenearth/move-left.gif" width="29" height="25" class="aFilter" /></div> 
                        <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
