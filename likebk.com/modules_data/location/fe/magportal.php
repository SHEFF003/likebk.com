    ...
    <td><form id="form1" name="form1" method="post" action="main.php?go_psh=1">
	  ...
	  <? if($u->info['admin'] == 1) {?>
		<label>
          ...
          <img src="http://img.likebk.com/i/city_ico2/mooncity.gif" width="33" height="19" style="vertical-align:bottom" />
          Пещера Тысячи Проклятий (Moon City)</label>
        <br />
        <label>
		
          <input name="p1" type="radio" id="p1_1" value="Бездна" />
          <img src="http://img.likebk.com/i/city_ico2/angelscity.gif" width="33" height="19" style="vertical-align:bottom" />
          Бездна (Angels City)</label>
        <br />
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Пещеры Мглы" id="p1_2" />
          <img src="http://img.likebk.com/i/city_ico2/sandcity.gif" width="33" height="19" style="vertical-align:bottom" />
          Пещеры Мглы (Sand City)</label>
        <br />
        <label>
          <input  disabled="disabled" type="radio" name="p1" value="Потерянный Вход" id="p1_4" />
          <img src="http://img.likebk.com/i/city_ico2/emeraldscity.gif" width="33" height="19" style="vertical-align:bottom" />
          Потерянный Вход (Emeralds City)</label>
        <br />
        
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Грибница" id="p1_6" />
          <img src="http://img.likebk.com/i/city_ico2/suncity.gif" width="33" height="19" style="vertical-align:bottom" />
          Грибница (Sun City)</label>
        <br />
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Сторожевая Башня" id="p1_7" />
          <img src="http://img.likebk.com/i/city_ico2/abandonedplain.gif" width="33" height="19" style="vertical-align:bottom" />
          Сторожевая Башня (Abandoned Plain)</label>
        <br />
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Туманные Низины" id="p1_8" />
          <img src="http://img.likebk.com/i/city_ico2/devilscity.gif" width="33" height="19" style="vertical-align:bottom" />
          Туманные Низины (Devils City)</label>
        <br />
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Гора Легиона" id="p1_9" />
          <img src="http://img.likebk.com/i/city_ico2/legion.gif" width="33" height="19" style="vertical-align:bottom" />
          Гора Легиона (Abandoned Plain)</label>
        <br />
        <label>
          <input disabled="disabled" type="radio" name="p1" value="Ледяная Пещера" id="p1_10" />
          <img src="http://img.likebk.com/i/city_ico2/snowcity.gif" width="33" height="19" style="vertical-align:bottom" />
          Ледяная Пещера (Snow City)</label>
		  <? }?>
		  <br/>
		  <label>
          <input type="radio" name="p1" value="Канализация" id="p1_5" />
          <img src="http://img.likebk.com/i/city_ico2/dreamscity.gif" width="33" height="19" style="vertical-align:bottom" />
          Канализация (Dreams City)</label>
		  <label>
		  <br/>
          <input name="p1" type="radio" id="p1_3" value="Катакомбы" />
          <img src="http://img.likebk.com/i/city_ico2/demonscity.gif" width="33" height="19" style="vertical-align:bottom" />
