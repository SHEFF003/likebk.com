                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      <img src="http://img.likebk.com/newcap/nc_bg1.jpg" alt="" name="img_ione" width="500" height="268" border="1" id="img_ione"/>
                      ...
                      <script language="javascript" type="text/javascript">
                        ...
                        -->
                      </script><!-- <div style="position:absolute; left:166px; top:149px; width:27px; height:55px; z-index:99;"><img  src="http://img.likebk.com/i/images/300x225/capital/2pm.gif" width="27" height="55" title="Памятник Мироздателю" /></div> -->
                      <div style="position:absolute; left:302px; top:177px; width:75px; height:90px; z-index:94;"><img src="http://img.likebk.com/newcap/nc_station.gif" alt="" width="75" height="90" <? thisInfRm('5.180.0.306'); ?> /></div>
                      
                      <div style="position: absolute; left: 103px; top: 159px; width: 75px; height: 90px; z-index: 94;"><img src="http://img.likebk.com/newcap/nc_station.gif" alt="" width="75" height="90" <? thisInfRm('5.180.0.352'); ?> /></div>
                                            
                      <div style="position:absolute; left:185px; top:37px; width:180px; height:120px; z-index:94;"><img src="http://img.likebk.com/newcap/nc_club.gif" alt="" width="180" height="120" <? thisInfRm('5.180.0.308'); ?> /></div>
                      <div id="snow"></div>
                        <? echo $goline; ?>
                      </div>
                    </td>
