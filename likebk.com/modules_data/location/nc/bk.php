                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer; width: 500;" id="ione"><img src="http://img.likebk.com/i/images/300x225/club/navig.jpg" id="img_ione" width="500" height="240"  border="1"/>
                      ...
                      <div style="position:absolute; left:184px; top:94px; width:120px; height:35px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/map_bk.gif" width="120" height="35" title="" class="aFilter" /></div>
					  ...
					  <div style="position:absolute; left:196px; top:148px; width:103px; height:47px; z-index:90;"><img <? thisInfRm('5.180.0.307'); ?> onClick="location='main.php?loc=5.180.0.307';" onMouseOver="this.className='aFilterhover';" onMouseOut="this.className='aFilter';" src="http://img.likebk.com/i/images/300x225/map_klub7.gif" width="103" height="47"  class="aFilter" /></div>
					  <div id="snow"></div>
                      <? echo $goline; ?>
                    </div>
                    </td>
