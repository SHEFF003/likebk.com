                ...
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <div style="position:relative; cursor: pointer; width: 500;" id="ione"><img src="http://img.likebk.com/i/images/300x225/club/navig.jpg" id="img_ione" width="500" height="240"  border="1"/>
					  <div style="position:absolute; left:395px; top:142px; width:16px; height:18px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/fl1.gif" width="16" height="18" title="Вы находитесь в '<? echo $u->room['name']; ?>'" /></div>
					  ...
					  <div style="position:absolute; left:312px; top:168px; width:123px; height:31px; z-index:90;"><img src="http://img.likebk.com/i/images/300x225/map_klub3.gif" width="123" height="31" title="" /></div>
