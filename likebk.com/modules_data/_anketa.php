...
if($u->info['id'] == 129431185) { die('Сам сказал )))'); }
?>
...
<TD valign=top>
<!-- <INPUT TYPE=button value="Подсказка" style="background-color:#A9AFC0" onclick="window.open('/encicl/help/psw.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')">&nbsp;--><INPUT TYPE=button value="Вернуться" onclick='location="/main.php"'>
</TD>
</TR></TABLE>
<?
$dateofbirth  = '';
if(isset($_POST['name']))
{
	...
	$_POST['homepage'] = htmlspecialchars(str_replace('"','&quot;',$_POST['homepage']),NULL,'cp1251');
...
<tr>
<td><input name="name" value="<?=$u->info['name']?>" class="inup" size="45" maxlength="90" /></td>
</tr>
</table></td>
</tr>
<?if($u->info['level']<=7) {?>
...
<tr bgcolor="#D3D2D0">
<td>ICQ:</td>
<td><input value="<? if($u->info['icq']>0) {echo $u->info['icq'];}?>" name="icq" class="inup" size="9" maxlength="20" /> <INPUT type=checkbox name='hide_icq' value=1 <?if($u->info['icq_hide']==1){echo'checked';}?>> не отображать в инф. о персонаже.</td>
</tr>
<tr bgcolor="#D3D2D0">
...
<tr bgcolor="#D3D2D0">
<td colspan="2" align="left">Увлечения / хобби <small><!-- (не более 5000 слов) --></small><BR>
<textarea name="hobby" cols="60" rows="15" class="inup" style='width:95%'><?=$u->info['hobby']?></textarea></td>
</tr>
<tr bgcolor="#D3D2D0">
