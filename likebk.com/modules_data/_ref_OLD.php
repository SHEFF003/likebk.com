...
- набирая опыт в боях и поднимаясь по апам и уровням в соответствии с <a href=http://lib.likebk.com/main/85 target=_blank>Таблицей Опыта</a> (доступно на любом уровне)<br>
...
<b>12го</b> уровня - <b>50 екр</b>.<br>
          ...
          <p>Ваша уникальная ссылка 
            <input style="background-color:#FBFBFB; border:1px solid #EFEFEF; padding:5px;" size="45" value="likebk.com/register.php?ref=<?=$u->info['id']?>"  /> или <input style="background-color:#FBFBFB; border:1px solid #EFEFEF; padding:5px;" size="45" value="likebk.com/r<?=$u->info['id']?>"  />
          </p></td>
      </tr>
      <tr>
        <td colspan="4"><p>&nbsp;</p>
