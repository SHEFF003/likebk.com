...
#adm .title .button { border:1px solid #bebebe; font-family:"Minion Pro", Times, "Times New Roman", serif; margin:0px 3px; padding: 1px 15px; font-size: 13px; border-radius:12px; background:url('//img.likebk.com/admin/adm_inputs_bg.png') no-repeat center center;}
#adm .menu { font-size:16px; padding:0px 20px;background:url('//img.likebk.com/admin/adm_menu_bg.png') repeat-x top; height:28px;}
...
#adm .menu a:hover, #adm .menu a.active { text-decoration:underline; color:#f7f7f7; background:url('//img.likebk.com/admin/adm_menu_bg-active.png') repeat-x top;}
...
#adm .content .cell .t.right .f { background:url('//img.likebk.com/admin/adm_bg-create.png') no-repeat top right;   padding:10px 14px; width:350px; }
...
.userPost { padding: 8px 20px; background:url('//img.likebk.com/admin/user_post-old.png') no-repeat top right; }
.userPost.hot{ background:url('//img.likebk.com/admin/user_post-hot.png') no-repeat top right; }
.userPost.new { background:url('//img.likebk.com/admin/user_post-new.png') no-repeat top right; }
.admPost { padding: 8px 20px; background:url('//img.likebk.com/admin/adm_post-old.png') no-repeat bottom left; }
.admPost.hot{ background:url('//img.likebk.com/admin/adm_post-hot.png') no-repeat bottom left; }
.admPost.new { background:url('//img.likebk.com/admin/adm_post-new.png') no-repeat bottom left; }
.moderPost { padding: 8px 20px; background:url('//img.likebk.com/admin/moder_post-old.png') no-repeat bottom left; }
.moderPost.hot{ background:url('//img.likebk.com/admin/moder_post-hot.png') no-repeat bottom left; }
.moderPost.new { background:url('//img.likebk.com/admin/moder_post-new.png') no-repeat bottom left; }
</style>
<? 
...
if($data OR $u->info['admin']>0){ // if moder or admin
	...
	while ($r = mysql_fetch_array($bugs)) { // Вывод списка  
		...
		$func="";
		$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=read\"><img src=\"//img.likebk.com/admin/read.png\" height=\"16\"/></a>"; // Отметить - Я прочитал
		if($u->info['admin']>0 OR $data)$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=update\"><img src=\"//img.likebk.com/admin/update.png\" height=\"16\"/></a>"; // Вернуть отметку - Я не прочел
		//if($u->info['admin']>0 OR $data)$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=edit\"><img src=\"//img.likebk.com/admin/edit.png\" height=\"16\"/></a>";
		$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=delete\"><img src=\"//img.likebk.com/admin/close.png\" height=\"16\"/></a>";
...
// if user
	...
	while ($r = mysql_fetch_array($bugs)) {
		...
		$func="";
		$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=read\"><img src=\"//img.likebk.com/admin/read.png\" height=\"16\"/></a>"; // Отметить - Я прочитал
		$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=update\"><img src=\"//img.likebk.com/admin/update.png\" height=\"16\"/></a>"; // Вернуть отметку - Я не прочел
		$func.="<a href=\"main.php?bagreport=1&post=".$r['id']."&action=delete\"><img src=\"//img.likebk.com/admin/close.png\" height=\"16\"/></a>"; // Закрыть мою тему
