...
<br />
<br />
Опыт: <a href="http://lib.likebk.com/main/85" target="_blank"><?=$u->info['exp']?></a> (<?=$u->stats['levels']['exp']?>)<br />
...
$aba = '';
if( $u->info['ability'] > 0 ) {
	$aba = ' <a href="main.php?skills=1&side=5"><img src="http://img.likebk.com/i/up.gif"></a>';
}
$skls = '';
if( $u->info['skills'] > 0 ) {
	$skls = ' <a href="main.php?skills=1&side=5"><img src="http://img.likebk.com/i/up.gif"></a>';
}
?>
