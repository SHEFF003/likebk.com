...
<link rel=stylesheet type="text/css" href="http://img.likebk.com/main.css">
<link href="http://img.likebk.com/move/design3.css" rel="stylesheet" type="text/css">
...
{   var s = '<table width=250 cellspacing=1 cellpadding=0 bgcolor=CCC3AA><tr><td align=center><B>'+title+'</td><td width=20 align=right valign=top style="cursor: hand" onclick="closehint3();"><BIG><B>x</td></tr><tr><td colspan=2>';
	...
	s += '<INPUT type=image SRC=http://img.likebk.com/i/b__ok.gif WIDTH=25 HEIGHT=18 ALT="Сохранить" style="border:0; vertical-align: middle"></TD></TR></TABLE><INPUT TYPE=hidden name=sd4 value=""></TD></FORM></TR></TABLE></td></tr></table>';
...
s += '<INPUT type=image SRC=http://img.likebk.com/i/b__ok.gif WIDTH=25 HEIGHT=18 ALT="Добавить контакт" style="border:0; vertical-align: middle"></TD></TR></TABLE><INPUT TYPE=hidden name=sd4 value="1"></TD></FORM></TR></TABLE></td></tr></table>';
document.all("hint4").innerHTML = s;
document.all("hint4").style.visibility = "visible";
document.all("hint4").style.left = 100;
document.all("hint4").style.top = document.body.scrollTop+50;
...
s+='<a href="javascript:top.addTo(\''+login+'\',\'private\')"><IMG SRC=http://img.likebk.com/i/lock.gif WIDTH=20 HEIGHT=15 ALT="Приватно"'+(battle!=0?' style="filter: invert()"':'')+'></a>';
}
if (city!="") {
s+='<img src="http://img.likebk.com/misc/forum/fo'+city+'.gif" width=17 height=15>';
}
...
s+='<a href="javascript:top.addTo(\''+login+'\',\'to\');">'+login+'</a>['+level+']<a href=/inf.php?'+id+' target=_blank><IMG SRC=http://img.likebk.com/i/inf_.gif WIDTH=12 HEIGHT=11 ALT="Информация о персонаже"></a>';
...
s+='<FONT color=gray><b>'+login+'</b>['+level+']<a href=/inf.php?'+id+' target=_blank><IMG SRC=http://img.likebk.com/inf_dis.gif WIDTH=12 HEIGHT=11 ALT="Информация о персонаже"></a></td><td bgcolor=efeded nowrap>Нет в клубе';
} else {
if (nlevel==1) {
nlevel=2; //s="<BR>"+s;
}
...
s+='<FONT color=gray><i>'+login+'</i> <a href=/inf.php?login='+mlogin+' target=_blank><IMG SRC=http://img.likebk.com/inf_dis.gif WIDTH=12 HEIGHT=11 ALT="Информация о персонаже"></a></td><td bgcolor=efeded nowrap>нет в этом городе';
}
s+='</FONT>';
}
document.write(s+'<BR>');
...
var s='';
s+='<a href="javascript:top.addTo(\''+login+'\',\'private\')"><IMG SRC=http://img.likebk.com/i/lock.gif WIDTH=20 HEIGHT=15 ALT="Приватно"></a>';
s+=' <IMG SRC=http://img.likebk.com/i/align/align'+align+'.gif WIDTH=12 HEIGHT=15>';
if (klan!='') {
...
s+="<B>"+name+"</B>";
if (level!=-1) s+=" ["+level+"]";
if (id!=-1 && !img) s+="<A HREF='/inf.php?"+id+"' target='_blank'><IMG SRC=http://img.likebk.com/i/inf_.gif WIDTH=12 HEIGHT=11 ALT='Инф. о "+name+"'></A>";
if (img) s+="<A HREF='/encicl/obraz_"+(sex?"w":"m")+"1.html?l="+img+"' target='_blank'><IMG SRC=http://img.likebk.com/i/inf_.gif WIDTH=12 HEIGHT=11 ALT='Образ "+name+"'></A>";
return s;
}
</SCRIPT>
