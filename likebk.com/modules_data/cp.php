...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="230" valign="top" style="padding-top:19px;">
      <? include('modules_data/stats_loc.php'); ?>
    </td>
                  ...
                  <tr>
                    <td>
                      ...
                      <script language="javascript" type="text/javascript">
                        ...
                        <div style="position:absolute; left:142px; top:17px; width:236px; height:157px; z-index:90;"><img <? thisInfRm('1.180.0.3'); ?> onClick="location='main.php?loc=1.180.0.3';" src="http://img.likebk.com/i/images/300x225/capital/2klub.gif" width="236" height="157"  class="aFilter" /></div>    
                                 
                        <div style="position:absolute; left:195px; top:143px; width:73px; height:47px; z-index:100;"><img  <? thisInfRm('1.180.0.10'); ?> src="http://img.likebk.com/i/images/300x225/capital/2shop.gif" width="73" height="47"  class="aFilter" /></div>
        				
                        <div style="position:absolute; left:80px; top:197px; width:42px; height:35px; z-index:100;"><img  <? thisInfRm('1.180.0.293'); ?> src="http://img.likebk.com/i/images/300x225/demons/dm_dungeon.gif" width="42" height="35"  class="aFilter" /></div>
        
                        <div style="position:absolute; left:50px; top:143px; width:48px; height:36px; z-index:91;"><img   <? thisInfRm('1.180.0.272'); ?> src="http://img.likebk.com/i/images/300x225/capital/2comission.gif" width="48" height="36"  class="aFilter" /></div>
        
                        <div style="position:absolute; left:244px; top:170px; width:71px; height:45px; z-index:91;"><img  <? thisInfRm('1.180.0.210'); ?> src="http://img.likebk.com/i/images/300x225/capital/2remont.gif" width="71" height="45"  class="aFilter" /></div>
        
                        <div style="position:absolute; left:303px; top:150px; width:79px; height:88px; z-index:93;"><img  <? thisInfRm('1.180.0.x'); ?> src="http://img.likebk.com/i/images/300x225/capital/2cerkov.gif" width="79" height="88" /></div>
        
                        <div style="position:absolute; left:330px; top:130px; width:111px; height:72px; z-index:92;"><img <? thisInfRm('1.180.0.226'); ?> src="http://img.likebk.com/i/images/300x225/capital/2pochta.gif" width="111" height="72" class="aFilter" /></div>
        
                        <div style="position:absolute; left:73px; top:135px; width:92px; height:62px; z-index:92;"><img   <? thisInfRm('1.180.0.14'); ?>  onclick="alert('Не работает. Находится на реконструкции.')"  onMouseOver="this.className='aFilterhover';" onMouseOut="this.className='aFilter';" src="http://img.likebk.com/i/images/300x225/capital/2vokzal.gif" width="92" height="62" class="aFilter" /></div>
                        ...
                        <div style="position:absolute; left:140px; top:119px; width:75px; height:90px; z-index:101;"><img src="http://img.likebk.com/i/elka.gif" width="75" height="90" <? thisInfRm('1.180.0.208'); ?> onClick="location='main.php?loc=1.180.0.208';" class="aFilter" /></div>
