...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	if($u->info['admin'] > 0) {
		...
		echo '<small style="float:right;border-bottom:1px solid black;padding-bottom:2px;"><a href="javascript:window.open(\'http://likebk.com/quest_dlg_edit.php?pid='.((int)$dialog->pg).'\',\'winEdi1\',\'width=850,height=400,top=400,left=500,resizable=no,scrollbars=yes,status=no\');" target="_blank">Редактировать текст</a> &nbsp; | &nbsp; Страницы: '.$dpages.'</small><br><br>';	
	}
	echo $dialog->dText; ?></p>
