...
<P align=right><INPUT TYPE=button value="Подсказка" style="background-color:#A9AFC0" onclick="window.open('/encicl/help/schet.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')">
<INPUT TYPE="button" onClick="top.frames['main'].location = 'main.php';" value="Вернуться" name=edit></P>
...
Укажите дату, на которую хотите получить отчет: <INPUT TYPE=text NAME=date value="<?=date('d.m.Y',$odate)?>"> <INPUT TYPE=submit name=schet value="Заказать отчет">
</FORM>
<?='<br>'.$red?>