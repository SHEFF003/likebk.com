...
var fight = {
	...
	userPers:function( uid ) {
			...
			if( this.base.users[uid] != undefined ) {
				var itms = {
					1 : '<img src="http://img.likebk.com/i/items/w/w9.gif" width="60" height="60">',
					2 : '<img src="http://img.likebk.com/i/items/w/w13.gif" width="60" height="40">',
					3 : '<img src="http://img.likebk.com/i/items/w/w3.gif" width="60" height="60">',
					4 : '<img src="http://img.likebk.com/i/items/w/w4.gif" width="60" height="80">',
					5 : '<img src="http://img.likebk.com/i/items/w/w5.gif" width="60" height="40">',
					6 : '<img src="http://img.likebk.com/i/items/w/w1.gif" width="60" height="20">',
					7 : '<img src="http://img.likebk.com/i/items/w/w2.gif" width="60" height="20">',
					8 : '<img src="http://img.likebk.com/i/items/w/w6.gif" width="20" height="20">',
					9 : '<img src="http://img.likebk.com/i/items/w/w6.gif" width="20" height="20">',
					10: '<img src="http://img.likebk.com/i/items/w/w6.gif" width="20" height="20">',
					11: '<img src="http://img.likebk.com/i/items/w/w11.gif" width="60" height="40">',
					12: '<img src="http://img.likebk.com/i/items/w/w10.gif" width="60" height="60">',
					13: '<img src="http://img.likebk.com/i/items/w/w19.gif" width="60" height="80">',
					14: '<img src="http://img.likebk.com/i/items/w/w12.gif" width="60" height="40">',
					//
					15: '<img src="http://img.likebk.com/i/items/w/w15.gif" width="40" height="20">',
					16: '<img src="http://img.likebk.com/i/items/w/w15.gif" width="40" height="20">',
					17: '<img src="http://img.likebk.com/i/items/w/w15.gif" width="40" height="20">',
					18: '<img src="http://img.likebk.com/i/items/w/w20.gif" width="40" height="20">',
					19: '<img src="http://img.likebk.com/i/items/w/w20.gif" width="40" height="20">',
					20: '<img src="http://img.likebk.com/i/items/w/w20.gif" width="40" height="20">'
				};
					  ...
					  '<tr>'+
						...
						'<td width="120"><table width="120" border="0" cellspacing="0" cellpadding="0">'+
						  '<tr>'+
							...
							'</tr>'+
						  '<tr>'+
							'<td style="background-image:url(\'http://img.likebk.com/i/obraz/' + this.base.users[uid].info['sex'] + '/' + this.base.users[uid].info['obraz'] + '\')" height="220" align="left" valign="top">&nbsp;</td>'+
						  '</tr>'+
						  '<tr>'+
	...
	userInf:function( uid ) {
			...
			if( this.base.users[uid] != undefined ) {
				if( this.base.users[uid].info['align'] > 0 ) {
					r += '<img src="http://img.likebk.com/i/align/align' + this.base.users[uid].info['align'] + '.gif" width="12" height="15">';
				}
				if( this.base.users[uid].info['clan'] > 0 ) {
					r += '<img src="http://img.likebk.com/i/clan/' + this.base.users[uid].info['clan'] + '.gif" width="24" height="15">';
				}
				...
				r += '<a href="http://likebk.com/inf.php?' + this.base.users[uid].info['id'] + '" target="_blank"><img src="http://img.likebk.com/i/inf_capitalcity.gif" width="12" height="11"></a>';
			}
			return r;	
		},
	f5:function() {
        ...
        <div id="u_main">
            <table class="b_tbl" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="20"><img title="Очистить логи боя" src="http://img.likebk.com/i/ico_clear_log.gif" width="16" height="19" /></td>
                    <td width="20">&nbsp;</td>
                    <td align="center" valign="middle">
                    	<input type="button" value="Вперёд!!!" />
                    </td>
                    <td width="20"><img title="Смена противника" src="http://img.likebk.com/i/ico_change.gif" width="16" height="19" /></td>
                    <td width="20"><img onclick="fight.f5()" title="Обновить" src="http://img.likebk.com/i/ico_refresh.gif" width="16" height="19" /></td>
                  </tr>
                  </table>
                <!-- -->
                </td>
