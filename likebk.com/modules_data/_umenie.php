...
while($pl = mysql_fetch_array($sp))
{
	...
	if(isset($itm['id']))
	{
		...
		$znn .= '<a target="_blank" href="http://lib.'.$c['host'].'/items_info.php?id='.$pl['vals'].'&rnd='.$code.'"><img style="margin:2px;" src="http://img.likebk.com/i/items/'.$itm['img'].'" onMouseOver="top.hi(this,\'Изучено: <b>'.$itm['name'].'</b>'.$lvar.'\',event,3,0,1,1);" onMouseOut="top.hic();" onMouseDown="top.hic();" /></a> ';
	}else{
		$znn .= '<img style="margin:2px;" src="http://img.likebk.com/i/items/nozn.gif" title="Изученное: Неизвестное знание" /> ';
	}
}
...
<INPUT TYPE=button class="btnnew" style="font-size: 13px; padding-top:3px; padding-bottom: 3px;" value='Обновить' onclick='location="main.php?skills=1&rz="+newrz+"&all=<?=$_GET['all'];?>&rnd=<? echo $code; ?>"'>
<INPUT TYPE=button class="btnnew" style="font-size: 13px; padding-top:3px; padding-bottom: 3px;" value="Вернуться" onClick="location.href='main.php'"></div>
</TABLE>
<TABLE border=0 cellspacing=0 cellpadding=0 width=100%>
<TD width=30% valign=top>
<TABLE border=0 cellspacing=1 cellpadding=0 width=100%>
<TR>
<TD height="25" class=tzS>Характеристики персонажа</TD>
...
<?if ($u->info['ability']>0){?><TD><IMG id="minus_str" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" id="plus_str"></TD><?}?>
</TR>
...
<?if ($u->info['ability']>0){?><TD><IMG id="minus_dex" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" id="plus_dex"></TD><?}?>
</TR>
...
<?if ($u->info['ability']>0){?><TD><IMG id="minus_inst" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" id="plus_inst"></TD><?}?>
</TR>
...
<?if ($u->info['ability']>0){?><TD><IMG id="minus_power" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_power"></TD><?}?>
</TR>
<?if ($u->info['level'] > 3) {?>
...
<?if ($u->info['ability']>0){?><TD><IMG id="minus_intel" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_intel"></TD><?}?>
</TR>
<?}if ($u->info['level'] > 6) {?>
...
<TD width=60 noWrap></TD>
<?if ($u->info['ability']>0){?><TD><IMG id="minus_wis" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_wis"></TD><?}?>
</TR>
<?}if ($u->info['level'] > 9) {?>
...
<TD width=60 noWrap></TD>
<?if ($u->info['ability']>0){?><TD><IMG id="minus_spirit" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_spirit"></TD><?}?>
</TR>
<?}if ($u->info['level'] > 12) {?>
...
<TD width=60 noWrap></TD>
<?if ($u->info['ability']>0){?><TD><IMG id="minus_will" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_will"></TD><?}?>
</TR>
<?}if ($u->info['level'] > 15) {?>
...
<TD width=60 noWrap></TD>
<?if ($u->info['ability']>0){?><TD><IMG id="minus_freedom" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_freedom"></TD><?}?>
</TR>
<?}if ($u->info['level'] > 18) {?>
...
<TD width=60 noWrap></TD>
<?if ($u->info['ability']>0){?><TD><IMG id="minus_god" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_god"></TD><?}?>
</TR>
<?}?>
<?
...
<?
/*
if ($u->info['ability']>0){?><TD><IMG id="minus_energy" SRC=http://img.likebk.com/i/minus.gif class="nonactive" ALT="уменьшить">&nbsp;<IMG SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить"  id="plus_energy"></TD><?
} */?>
</TR>
</TABLE>
<INPUT type="button" class="btnnew" style="font-size: 13px; padding-top:3px; padding-bottom: 3px;" value="сохранить" disabled id="save_button0" onClick="SaveSkill()">
...
<Br>
<b>Зависимость профильного урона оружием:</b><br>
- <b>Дробящий</b> (<b>дубины и булавы</b>): 95% Силы.<br>
- <b>Режущий</b> (<b>мечи</b>): 45% Силы и 45% Интуиции.<br>
- <b>Колющий</b> (<b>ножи и кинжалы</b>): 45% Силы и 55% Ловкости.<br>
- <b>Рубящий</b> (<b>топоры</b>): 60% Силы 30% Ловкости и 10% Интуиции.<br>
<BR><BR>
</FONT>
</TABLE>
<SCRIPT> 
...
<TD class=tz id=L1 width=150 height="25" onMouseOver="highl('L1',1)" onMouseOut="highl('L1',0)" onClick="setlevel('L1')">Мастерство</TD>
<? if($u->info['level']>1){ ?>
...
<? } ?>
<TD>
<? if($znn!=''){ ?><TD class=tz id=L7 width=150 onMouseOver="highl('L7',1)" onMouseOut="highl('L7',0)" onClick="setlevel('L7')">Знания</TD><? } ?>
<TD>
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_axe" SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_axe', -1, <?=$st['a4']?>)">&nbsp;
<IMG id="plus_m_axe" SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_axe', 1, <?=$st['a4']?>)">
</TD>
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_molot" SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_molot', -1, <?=$st['a3']?>)">&nbsp;
<IMG id="plus_m_molot" SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_molot', 1, <?=$st['a3']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_sword" SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_sword', -1, <?=$st['a1']?>)">&nbsp;
<IMG id="plus_m_sword" SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_sword', 1, <?=$st['a1']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_tohand" SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_tohand', -1, <?=$st['a2']?>)">&nbsp;
<IMG id="plus_m_tohand" SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_tohand', 1, <?=$st['a2']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_staff" SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_staff', -1, <?=$st['a5']?>)">&nbsp;
<IMG id="plus_m_staff" SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_staff', 1, <?=$st['a5']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_magic1"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic1', -1, <?=$st['mg1']?>)">&nbsp;
<IMG id="plus_m_magic1"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic1', 1, <?=$st['mg1']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_magic2"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic2', -1, <?=$st['mg2']?>)">&nbsp;
<IMG id="plus_m_magic2"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic2', 1, <?=$st['mg2']?>)">
</TD>
<? }elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<? if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_magic3"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic3', -1, <?=$st['mg3']?>)">&nbsp;
<IMG id="plus_m_magic3"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic3', 1, <?=$st['mg3']?>)">
</TD>
<? }elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_magic4"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic4', -1, <?=$st['mg4']?>)">&nbsp;
<IMG id="plus_m_magic4"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic4', 1, <?=$st['mg4']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<?if ($u->info['skills']){?>
<TD>
<IMG id="minus_m_magic5"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic5', -1, <?=$st['mg5']?>)">&nbsp;
<IMG id="plus_m_magic5"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic5', 1, <?=$st['mg5']?>)">
</TD>
<?}elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<? if($u->info['skills']){ ?>
<TD>
<IMG id="minus_m_magic6"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic6', -1, <?=$st['mg6']?>)">&nbsp;
<IMG id="plus_m_magic6"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic6', 1, <?=$st['mg6']?>)">
</TD>
<? }elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<? if ($u->info['skills']){ ?>
<TD>
<IMG id="minus_m_magic7"  SRC=http://img.likebk.com/i/minus.gif class=nonactive ALT="уменьшить" onMouseUp="ChangeAbility('m_magic7', -1, <?=$st['mg7']?>)">&nbsp;
<IMG id="plus_m_magic7"  SRC=http://img.likebk.com/i/plus.gif class=skill ALT="увеличить" onMouseUp="ChangeAbility('m_magic7', 1, <?=$st['mg7']?>)">
</TD>
<? }elseif($u->info['skills']>0){?>
<TD>
<IMG SRC=http://img.likebk.com/i/minus.gif class=nonactive>&nbsp;
...
<TABLE>
<TR valign="middle">
<TD><INPUT type="button" class="btnnew" style="font-size: 13px; padding-top:3px; padding-bottom: 3px;" value="сохранить" disabled id="save_button1" onClick="SaveAbility()"></TD>
...
if(isset($test1['id'])) {
	$dalign = array(
		1 => '<img src="http://img.likebk.com/i/align/align1.gif"> Светлая',
		3 => '<img src="http://img.likebk.com/i/align/align3.gif"> Темная',
		7 => '<img src="http://img.likebk.com/i/align/align7.gif"> Нейтральная'
	);
	$html .= '<div>&nbsp;&nbsp; &bull; Задержка на выбор склонности еще '.$u->timeOut($test1['time']+86400*7-time()).' (Доступная склонность: '.$dalign[$test1['align']].')</div>';
}
...
if(isset($test2['id'])) {
	...
	if(isset($dalign['id'])) {
		...
		$dalign = '<i>Неизвестный клан</i>';
	}
	$html .= '<div>&nbsp;&nbsp; &bull; Задержка на выбор клана еще '.$u->timeOut($test1['time']+86400*3-time()).' (Доступный клан: '.$dalign.')</div>';
}

if($html != '') {
	echo '&nbsp;<b>Задержки:</b><br>'.$html.'<br><br>';
}
unset($html);
...
echo '<b>Рейтинг:</b> '.round($rating['global']/(10000+$u->info['level']),2).' <sup>(Вчера: '.round($rating['global']/(10000+$u->info['level']),2).')</sup><br><b>Позиция в ТОПе:</b> <a href="http://top.likebk.com/#'.$u->info['id'].'" target="_blank">'.$rating['pos'].'</a> <sup>'.$rtns.'</sup>';
...
while($pl = mysql_fetch_array($sp))
{
	...
	$pq['info'] = str_replace('&nbsp;',' ',$pq['info']);
	$qsee .= '<a href="main.php?skills=1&rz=6&end_qst_now='.$pq['id'].'"><img src="http://img.likebk.com/i/clear.gif" title="Отказаться от задания"></a> <b>'.$pq['name'].'</b><div style="padding-left:15px;padding-bottom:5px;border-bottom:1px solid grey"><small>'.$pq['info'].'<br>'.$q->info($pq).'</small></div><br>';
	$qx++;
}
...
$pshnames = array(
	...
	10	=> 'Грибница',
	11	=> 'Некровиль',
	12	=> 'Пещера Тысячи Проклятий',
	13	=> 'Гора Легиона',
	20	=> 'Ледяная Пещера',
	101 => 'Бездна',
	103	=> 'Катакомбы',
	102	=> 'Подземелье Драконов',
	104	=> 'Грибница'
...
while( $pl = mysql_fetch_array($sp) ) {
	...
	if( $pshname == '' ) {
		$pshname = '<i>Неизвестное подземелье</i>';
	}
	$pshzd .= '<br>&nbsp;<b>Время до подземелья ('.$pshname.'):</b> '.$u->timeOut(($pl['time']+10800)-time()).' (до '.date('d.m.Y H:i',$pl['time']).')';
}
...
&bull; <B>Гора</B> - <?=$u->rep_zv(4,$u->rep['repabandonedplain'])?><BR>
...
<? } if($u->rep['hip']>0){ ?>
&bull; <B>Хижина Искателей Приключений</B> - <?=($u->rep['hip']-$u->rep['hip_buy']).' (Собрано за все время: '.$u->rep['hip'].' ед.)'?><BR>
