...
if(date('m') != 4 && date('m') != 4 && $u->info['admin'] == 0) {
	die();
}
...
<div style="float: right; width: 210px;">
  <INPUT type='button' value='Обновить' onclick='location="/main.php?newybonus4=1"';'>
...
<div style="text-align: center; font-family: Arial; line-height: 24px;"><span style="font-size: 16px; font-weight: bold;">
  <h3 style="font-size: 24px; font-weight: bold; padding: 20px; padding-bottom: 0px; margin-bottom: 5px; text-align: center;">Майские праздники!</h3>
  <br>
  <small style="font-weight:normal;font-size:14px;">(Срок проведения марафона с 22.04.2017 по 14.05.2017)</small><br>
За каждый час проведенный в игре, вы сможете открыть один из трех сундуков, найти в них <img src="http://img.likebk.com/i/items/1mai1.gif"> "<font color="#b40611">Серп</font>" и дополнительные награды! За каждый <font color="#b40611">хаотичный бой</font> вы получите <img src="http://img.likebk.com/i/items/1mai2.gif"> &quot;<font color="#b40611">Молот</font>&quot;, а за каждый <font color="#b40611">пещерный бой</font>, с вероятностью в 10%, вы получите <img src="http://img.likebk.com/i/items/1mai3.gif"> &quot;<font color="#b40611">Майское знамя</font>&quot;! Собрав необходимое количество, наиболее активные игроки смогут поменять их на очень ценные призы, в числе которых <font color="#b40611"><img src="http://img.likebk.com/i/items/chek50.gif"> 10 чеков на получение екр</font>, а также <font color="#b40611"><img src="http://img.likebk.com/i/items/loto1b.jpg"> лотерейные билеты</font>, с призовым фондом <font color="#b40611" style="font-size:19px;">более 1300 екр</font>.
<?
...
Получить вышеперечисленные вещи вы можете в <font color="#b40611">&quot;Майском Магазине&quot;</font>, который находится на <font color="#b40611">&quot;Центральной Площади&quot;</font>.
...
if(isset($_GET['takeitnowfastbig'])) {
	if( $o1['time_all'] - $o2['time_online'] >= 3600 ) {
		echo '<div><font color="red"><b>Открыв сундук вы обнаружили предмет &quot;Серп&quot;!</b></font></div>';
		
		$u->addItem(8008,$u->info['id'],'|sudba='.$u->info['login'].'');
...
if( $o1['time_all'] - $o2['time_online'] >= 3600 ) {
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=1"><span class="button" style="pointer-events: none; cursor: default;">Открыть сундук №1</span></a>';
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=2"><span class="button" style="pointer-events: none; cursor: default;">Открыть сундук №2</span></a>';
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=3"><span class="button" style="pointer-events: none; cursor: default;">Открыть сундук №3</span></a>';
}else{
	echo 'Вам необходимо провести в онлайне еще '.$u->timeOut(( 3600 - ($o1['time_all'] - $o2['time_online']) )).'!';
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=1"><span class="button" style="pointer-events: none; cursor: default;opacity: 0.2;">Открыть сундук №1</span></a>';
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=2"><span class="button" style="pointer-events: none; cursor: default;opacity: 0.2;">Открыть сундук №2</span></a>';
	echo '<a href="/main.php?newybonus4&takeitnowfastbig=3"><span class="button" style="pointer-events: none; cursor: default;opacity: 0.2;">Открыть сундук №3</span></a>';
}	
