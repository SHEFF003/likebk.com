...
if($u->info['id'] == 155) {
	...
	<title>Визуальный редактор Лабиринтов &copy; likebk.com</title>
	...
	<? if(!isset($_GET['look'])){ echo 'var'; }?> users   = {<? echo $d->genUsers(); ?>};
	...
	function addObj(v,mz,iii){
		...
		if(dConfigObj[rz]!=undefined && dConfigObj[rz][v[6]]!=undefined) {
			...
			if( rz >= 1 && rz <= 2 ) {
				...
				zfloor0[rz] = '<img id="obj_true_'+v[0]+'_2" rz="'+rz+'" oncontextmenu="top.editObjResize(\'#obj_true_'+v[0]+'\',\''+v+'\',\''+iii+'\'); return false" title="'+v[1]+'" onClick="top.editObj(\'#obj_true_'+v[0]+'\',\''+v+'\')" src="http://img.likebk.com/1x1.gif" style="cursor:pointer;position:absolute;top:'+new_top+'px;left:'+new_left+'px;width:'+new_w+'px;height:'+new_h+'px;" />'+zfloor0[rz];			
			} else {
				zfloor0[rz] = '<img id="obj_true_'+v[0]+'_2" rz="'+rz+'" oncontextmenu="top.editObjResize(\'#obj_true_'+v[0]+'\',\''+v+'\',\''+iii+'\'); return false" title="'+v[1]+'" onClick="top.editObj(\'#obj_true_'+v[0]+'\',\''+v+'\')" src="http://img.likebk.com/1x1.gif" style="position:absolute;top:'+new_top+'px;left:'+new_left+'px;width:'+new_w+'px;height:'+new_h+'px;" />'+zfloor0[rz];
			}
			r = '<img id="obj_true_'+v[0]+'" rz="'+rz+'" oncontextmenu="top.editObjResize(\'#obj_true_'+v[0]+'\',\''+v[1]+'\',\''+iii+'\'); return false" onClick="top.editObj(\'#obj_true_'+v[0]+'\',\''+v[1]+'\')" title="obj" src="http://img.likebk.com/i/sprites/'+v[4]+'" class="dObj" style="position:absolute;top:'+new_top+'px;left:'+new_left+'px;width:'+new_w+'px;height:'+new_h+'px;" />';
		}
		return r;
	}
	  ...
	  <tr>
	    ...
	    if(!isset($test_id)) {
			...
			while($pl = mysql_fetch_array($sp)) {
				...
				$map[$pl['x']][$pl['y']] = '<img class="cq" onClick="top.goPix('.$pl['id'].','.$pl['x'].','.$pl['y'].');" id="px_'.$pl['id'].'" style="'.$style.'" width="20" height="20" src="http://img.likebk.com/1x1.gif" title="X: '.$pl['x'].', Y: '.$pl['y'].'">';
			}
			...
			while($i >= $min_y) {
				...
				while($j <= $max_x) {
					if(isset($map[$j][$i])) {
						...
						$r .= '<td><img style="vertical-align:bottom" width="1" height="1" src="http://img.likebk.com/1x1.gif"></td>';	
					}
					$j++;
				}
				$r .= '</tr>';	
