...
<script src="http://likebk.com:8099/socket.io/socket.io.js"></script>
<script>
var upd2017 = true;
...
<script type="text/javascript" src="js/onlineList.js?<?=time()?>"></script>
<script type="text/javascript" src="js/hpregen.js"></script>
<script type="text/javascript" src="js/jquery-fireHint.js"></script>
<!-- -->
<link rel="stylesheet" type="text/css" href="/v2/static/css/game.css" />
<script type="text/javascript" src="/v2/static/js/core.js" charset="utf-8"></script>
<script type="text/javascript" src="/v2/static/js/autosize.js"></script>
<script>
...
<body onLoad="bodyLoaded();cb_statusTest();open_cb(1,null);_bk.start();">
...
<script type="text/javascript" src="show_reg_img/jRumble.js"></script>
<script>
var refj = 0;
function sd4no() {
	$('#sd4drg').jrumble({
...
<div id="upbox" onselectstart="return false"></div>
    ...
    <div title="Новая почта" style="display:none; position:absolute; left: 198px; top: 13px; width:24px; height:15px; background-image:url(http://img.likebk.com/i/mail2.gif);" class="postdiv" id="postdiv"></div>
	
    <div id="volnorez_live_player001d11a9" style="width:350px;height:27px;display:block;position:absolute;left: 40%; margin-left: -155px;"><br />Слушать <a href="http://volnorez.com/likebk-online" title="радио LikeBK-online">радио LikeBK-online</a><br /><script type="text/javascript">(volnorez_jscode = window.volnorez_jscode || (function(){var s=document.createElement("script");s.type="text/javascript";s.src="//volnorez.com/plugins/jscode/js/jscode.js";document.body.appendChild(s);return [];})())["001d11a9"]={skinURL:"//volnorez.com/plugins/wcdesign/skins/liveplayer_skin.swf",skinParams:""};if (window.VolnorezJSCode) VolnorezJSCode.Load("001d11a9");</script><br /><br /></div>
                  ...
                  <tr>
                    ...
                    <td align="right" valign="top" background="http://img.likebk.com/i/lite/top_lite_low_15.gif" style="font-size:10px;">
                        ...
                        <?php //if($u->info['admin'] > 0) {?>
                        	<span style="display:;" id="menu4"><a style="color: green; font-weight: bold;" href="/main.php?referals=1&rn=<?=$c[9]?>" target="main" class="menutop">Реферальный Заработок</a> | 
                       	<?php //}?>
                       <a href="/main.php?inv=1&rn=<?=$c[9]?>" target="main" class="menutop">Инвентарь</a> | 
                       ...
                       <!-- | <a href="/seasons.php" target="main" class="menutop">Сезоны</a>--> | 
                        <a href="/main.php?anketa=1" target="main" class="menutop">Анкета</a>&nbsp;</span>
                    </td>
  ...
  <tr class="no_chat_mob">
    ...
    <table width="100%" height="26" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30"><img width="30" height="30" id="qel1" onclick="_bk.oUrl('main.php?inv=1&rnd='+c.rnd);" onMouseOver="top.hi(this,'Инвентарь',event,0,1,1,1,'max-height:240px');" onMouseOut="top.hic();" onMouseDown="top.hic();" class="db cp" src="http://img.likebk.com/i/buttons/chatBtn13.gif"></td>
		<td width="30"><img width="30" height="30" id="qel1001" onclick="_bk.mod.open('tickets');" onMouseOver="top.hi(this,'Обратная связь',event,0,1,1,1,'max-height:240px');" onMouseOut="top.hic();" onMouseDown="top.hic();" class="db cp" src="https://testbk.com/static/images/design/chatBtn22.gif"></td>
