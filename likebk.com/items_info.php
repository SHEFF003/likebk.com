...
if( !file_exists('../img.likebk.com/i/encicl/pict_'.$rz[$rt[$itm['type']]][0].'.jpg') == true ) {
	//subject
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr valign=top>
    <td><table width="100%" height="135"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td background="http://likebk.com/forum_script/img/line_capitalcity.jpg" scope="col" align=center><img style="display:block" src="http://likebk.com/inx/newlogo.jpg" border=0></td>
        </tr>
      </table></td>
  </tr>
</table>
...
document.write('<table cellspacing=0 cellpadding=0 bgcolor=#f2e5b1 border=0 width='+(wsize-20)+'>');
  ...
  <tr valign=top>
    <td width="29" rowspan=2 background="http://likebk.com/forum_script/img/leftground.jpg"><img src="http://img.likebk.com/i/encicl/pictlr_<?=$rz[$rt[$itm['type']]][0]?>.jpg" width="29" height="256"></td>
    <td width="118" align="left"><img id="imleft" src="http://img.likebk.com/i/encicl/pictl_<?=$rz[$rt[$itm['type']]][0]?>.jpg" width="118" height="257"><BR>
    </td>
    <td rowspan=2 align="left">     
      <p><b>»</b> <a href="http://likebk.com/item/">Предметы</a> / <?=$rz[$rt[$itm['type']]][1]?> / <b><i><?=$itm['name']?></i></b>  
      <h2><?=$itm['name']?></h2>
      <img src="http://img.likebk.com/i/encicl/ln3.jpg" width="400" height="1">
      </p>
    <? if( $img3dShow==false && (file_exists('../img.likebk.com/i/big/3d'.str_replace('.gif','',str_replace('.png','',$itm['img'])).'.jpg') == true) OR $img3dShow==true ) { ?>  
	<div align="center"> 
        <table width="504"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left"  width="12" height="10"><img style="display:block" src="http://img.likebk.com/i/encicl/ll12_30.gif" width="12" height="10"></td>
            <td width="100%" background="http://img.likebk.com/i/encicl/ram12_34.gif"></td>
            <td width="12" height="10" align="right"><img style="display:block" src="http://img.likebk.com/i/encicl/ll12_30.gif" width="12" height="10"></td>
          </tr>
          <tr>
            <td width="12" background="http://img.likebk.com/i/encicl/line_left_13.gif">&nbsp;</td>
            <td width="480"><img style="display:block" src="<? if( file_exists('../img.likebk.com/i/big/3d'.str_replace('.gif','',str_replace('.png','',$itm['img'])).'.jpg') == true ) { ?>http://img.likebk.com/i/big/3d<?=str_replace('.gif','',str_replace('.png','',$itm['img']))?>.jpg<? }else{ ?>http://img.likebk.com/i/big/back.jpg<? } ?>" alt="" width="480" height="360" border=1 id="bigim"></td>
            <td width="12" background="http://img.likebk.com/i/encicl/line_right_13.gif">&nbsp;</td>
          </tr>
          <tr>
           		  <td align="left" width="12" height="10"><img style="display:block" src="http://img.likebk.com/i/encicl/ll12_30.gif" width="12" height="10"></td>
                  <td width="100%" style="background-image:url(http://img.likebk.com/i/encicl/ram12_34down.gif); background-position:bottom"></td>
                  <td width="12" align="right"><img style="display:block" src="http://img.likebk.com/i/encicl/ll12_30.gif" width="12" height="10"></td>
          </tr>
        </table>
	</div>
	<? } ?>
...
<IMG SRC="http://img.likebk.com/i/align/align0.gif" WIDTH=12 HEIGHT=15>  
<?
if($admin == 1) {
	$crd = '<small><a href="javascript:window.open(\'http://likebk.com/item_edit_data.php?edit_item_data='.$itm['id'].'\',\'winEdi1\',\'width=850,height=400,top=400,left=500,resizable=no,scrollbars=yes,status=no\');" target="_blank">Редактировать предмет</a> </small> &nbsp; &nbsp;';
}
echo $crd;
...
if(isset($itd['art'])) {
	echo '<IMG SRC=http://img.likebk.com/i/artefact.gif WIDTH=18 HEIGHT=16 ALT="Артефактная вещь"> ';
}

				if(isset($po['sudba']))
				{
					echo '<img title="Этот предмет будет связан общей судьбой с первым, кто наденет его. Никто другой не сможет его использовать." src="http://img.likebk.com/i/destiny0.gif"> ';
				}
...
<a title="<?=$itm['name']?>" href="/item/<?=$itm['id']?>"><SPAN style='background-color: #E0E0E0'><img src="http://img.likebk.com/i/items/<?=$itm['img']?>" alt="<?=$itm['name']?>" name="image" border="0"></SPAN></a></td>
</tr>
</table>
      ...
      <p>
      <!-- End of text -->
    <td style='padding-left: 3' align=right><img id="imright" height=144 src="http://img.likebk.com/i/encicl/pict_<?=$rz[$rt[$itm['type']]][0]?>.jpg" width=139 border=0></td>
    <td valign=top background="http://likebk.com/forum_script/img/rightground.jpg">&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
  <tr valign=top>
    <td></td>
    <td valign=center style="padding-bottom:50" align="right"><IMG height=236 src="http://img.likebk.com/i/encicl/pictr_<?=$rz[$rt[$itm['type']]][0]?>.jpg" width=128 border=0></td>
    <td width="23" valign=top background="http://likebk.com/forum_script/img/rightground.jpg">&nbsp;</td>
  </tr>
</table>
<? }else{
...
document.write('<table cellspacing=0 cellpadding=0 bgcolor=#f2e5b1 border=0 width='+(wsize-20)+'>');
  ...
  <tr valign=top>
      <td width="29" rowspan=2 background="http://likebk.com/forum_script/img/leftground.jpg"><img src="http://img.likebk.com/i/encicl/pictlr_subject.jpg" width="29" height="256"></td>
      <td width="278" height="257" align="left"><img id="imleft2" src="http://img.likebk.com/i/encicl/pictl_subject.jpg" width="118" height="257"><BR></td>
    <td rowspan=2 align="left"><p><b>&raquo;</b> <a href="http://likebk.com/item/">Предметы</a> /
      <h2><?=$rname?></h2>
        <img src="http://img.likebk.com/i/encicl/ln3.jpg" width="400" height="1">
        </p>
	  <?
	      ...
	      <td align=left valign="top"><table width="95%"  border="0" align="center" cellpadding="3" cellspacing="0" class="inup3">
	        <tr>
	          <td width="100%"><A HREF="/item/<?=$itm['id']?>" target=_blank>
	            <?=$itm['name']?>
	            </A> <IMG SRC="http://img.likebk.com/i/align/align0.gif" WIDTH=12 HEIGHT=15>
	            <?
				if(isset($_GET['e1'])) {
					$crd = '<small><a href="javascript:window.open(\'http://likebk.com/item_edit_data.php?edit_item_data='.$itm['id'].'\',\'winEdi1\',\'width=850,height=400,top=400,left=500,resizable=no,scrollbars=yes,status=no\');" target="_blank">Редактировать предмет</a> </small> &nbsp; &nbsp;';
				}
...
*/
?></td>
	          <td align="center" valign="top" style='padding: 0,2,0,5'><a title="<?=$itm['name']?>" href="/item/<?=$itm['id']?>"><SPAN style='background-color: #E0E0E0'><img src="http://img.likebk.com/i/items/<?=$itm['img']?>" alt="<?=$itm['name']?>" name="image" border="0"></SPAN></a></td>
	          </tr>
	        </table>
        </tr>
      </table>
      ...
      <p align="center">&nbsp;</p>
        ...
        <p>
          <!-- End of text -->
    <td style='padding-left: 3' align=right><img id="imright2" height=144 src="http://img.likebk.com/i/encicl/pict_subject.jpg" width=139 border=0></td>
      <td valign=top background="http://likebk.com/forum_script/img/rightground.jpg">&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
  <tr valign=top>
    <td valign="top">
    ...
    <tr>
		<td width="12" align="left"><img src="http://img.likebk.com/ram12_33.gif" width="12" height="11"></td>
		<td style="background-image:url(http://img.likebk.com/ram12_34.gif); background-repeat:repeat-x; background-position:0 2px;"></td>
		<td width="13" align="right"><img src="http://img.likebk.com/ram12_35.gif" width="13" height="11"></td>
	</tr>
    </table><br>
    <b>Амуниция</b><br>
    ...
    <td valign="bottom" style="padding-bottom:50" align="right"><IMG height=236 src="http://img.likebk.com/i/encicl/pictr_subject.jpg" width=128 border=0></td>
    <td width="23" valign=top background="http://likebk.com/forum_script/img/rightground.jpg">&nbsp;</td>
  </tr>
</table>
<? } ?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor=#000000>
  <TR>
    <TD colspan=3 width="100%" height=13 background="http://img.likebk.com/i/encicl/ln_footer.jpg"></TD>
  </TR>
  <tr valign=top>
    <td width="20%"><div align="center">
&nbsp;
      </div></td>
    <td align=center valign=middle><div align="center" style="padding: 5px 0px; height: 32px; box-sizing: border-box;"><NOBR><span class="style6">Copyright © <?=date('Y')?> «www.likebk.com»</span></NOBR><br><Br></div></td>
    <td width="20%"></td>
  </tr>
</table>
</body>
