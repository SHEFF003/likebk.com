...
<a class="raiting" href="http://top.likebk.com/honor_raiting.php">Рейтинг Боев чести</a>
...
$sp = mysql_query('SELECT * FROM `users` WHERE (`pass` NOT LIKE "%saintlucia%" OR `pass` NOT LIKE "%saintlucia5%") ORDER BY `win_h` DESC LIMIT 250');
while( $pl = mysql_fetch_array($sp) ) {
	...
	//рейтинг
	$r .= '<td align="center" height="20" align=right valign="top" class="mystrong">'.number_format($pl['win_h'],0,'',' ').'</td>';
	//
	$r .= '</tr>';	
	$i++;
}
